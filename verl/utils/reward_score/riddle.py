...
def compute_score(predict_str: str, ground_truth: str, use_boxed: bool = True, format_score: float = 0.1) -> float:
    return acc_reward(predict_str, ground_truth, use_boxed) * format_reward(predict_str)


if __name__ == '__main__':
    print(compute_score("\\boxed{1}", "1"))
    print(compute_score("<think>Add</think>\\boxed{1}", "1"))
